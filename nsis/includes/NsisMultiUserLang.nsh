...
!ifdef LANG_SIMPCHINESE
	...
	LangString MULTIUSER_INSTALL_HEADER ${LANG_SIMPCHINESE} "选择是为所有用户还是为当前用户安装 $(^NameDA)。"
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_SIMPCHINESE} "所有用户和当前用户都安装了 $(^NameDA)。$\r$\n选择要删除的安装。"
	LangString MULTIUSER_ALL_USERS ${LANG_SIMPCHINESE} "适用于使用此计算机的所有人(&a)（所有用户）"
	LangString MULTIUSER_CURRENT_USER ${LANG_SIMPCHINESE} "对于我(&m)（{USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SIMPCHINESE} "给使用这台电脑的任何人（所有用户）"
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_SIMPCHINESE} "对于我 ({USER})"
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_SIMPCHINESE} "为所有用户重新安装。"
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_SIMPCHINESE} "为当前用户重新安装。"
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_SIMPCHINESE} "所有用户的版本 {VERSION} 已为安装在 $\"{FOLDER}$\" 中。"
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_SIMPCHINESE} "当前用户的版本 {VERSION} 已安装在 $\"{FOLDER}$\" 中。"
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_SIMPCHINESE} "为所有用户重新安装 {VERSION} 版本。"
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_SIMPCHINESE} "为当前用户重新安装 {VERSION} 版本。"
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_ALL_USERS ${LANG_SIMPCHINESE} "卸载版本 {OLD_VERSION}，为所有用户安装版本 {VERSION}。"
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_SIMPCHINESE} "为当前用户卸载 {OLD_VERSION} 版本并安装 {VERSION} 版本。"
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_SIMPCHINESE} "您需要以管理员身份运行该程序。"
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_SIMPCHINESE} "需要管理员授权。"
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_SIMPCHINESE} "卸载时需要管理员授权。"
	; error messages - not so important
	LangString MULTIUSER_INVALID_PARAMS ${LANG_SIMPCHINESE} "无效的参数组合。"
	LangString MULTIUSER_NOT_INSTALLED ${LANG_SIMPCHINESE} "没有安装 $(^NameDA)。"
	LangString MULTIUSER_INSTALLATION_FOR_CURRENT_USER_NOT_SUPPORTED ${LANG_SIMPCHINESE} "操作系统不支持当前用户的安装。"
	LangString MULTIUSER_ADMIN_ACCOUNT_LOGIN_REQUIRED ${LANG_SIMPCHINESE} "您需要使用管理员组的成员账户登录才能继续。"
	LangString MULTIUSER_ELEVATION_NOT_SUPPORTED ${LANG_SIMPCHINESE} "操作系统不支持提升权限。"
	LangString MULTIUSER_LOGON_SERVICE_NOT_RUNNING ${LANG_SIMPCHINESE} "无法提升权限，辅助登录服务未运行。"
	LangString MULTIUSER_ELEVATION_ERROR ${LANG_SIMPCHINESE} "无法提升权限，错误 {ERROR}。"
!endif
