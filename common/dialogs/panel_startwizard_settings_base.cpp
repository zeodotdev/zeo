...
PANEL_STARTWIZARD_SETTINGS_BASE::PANEL_STARTWIZARD_SETTINGS_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText2 = new wxStaticText( this, wxID_ANY, _("How would you like to configure Zeo?"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_lblPathError = new wxStaticText( this, wxID_ANY, _("The selected path does not contain valid Zeo settings!"), wxDefaultPosition, wxDefaultSize, 0 );
