...
// ZEO_VERSION macros are defined in kicad_build_version.h (generated by CMake)
// =============================================================================

wxString GetZeoVersion()
{
    wxString msg = wxString::Format( wxT( "%s" ), wxT( ZEO_VERSION ) );
    return msg;
}


wxString GetZeoMajorMinorPatchVersion()
{
    wxString msg = wxString::Format( wxT( "%s" ), wxT( ZEO_MAJOR_MINOR_PATCH_VERSION ) );
    return msg;
}


const std::tuple<int,int,int>& GetZeoMajorMinorPatchTuple()
{
    static std::tuple<int, int, int> retval = ZEO_MAJOR_MINOR_PATCH_TUPLE;
