...
std::vector<LLM_TOOL> GetToolDefinitions()
{
    ...
    // Tool: run_terminal - Execute bash/shell commands
    ...
    // Tool: open_editor - Open schematic or PCB editor with user approval
    LLM_TOOL openEditor;
    ...
    // Tool: sch_get_summary - Get high-level overview of schematic
    ...
    // Tool: sch_read_section - Read specific section of schematic
    ...
    // Tool: sch_modify - Add, update, or delete elements
    LLM_TOOL schModify;
    ...
    // Tool: sch_validate - Validate schematic file
