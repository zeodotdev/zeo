...
static const wxChar CoplanarGapHeightRatio[] = wxT( "ImpedanceCoplanarGapHeightRatio" );
...
void ADVANCED_CFG::loadSettings( wxConfigBase& aCfg )
{
    ...
    m_entries.push_back( std::make_unique<PARAM_CFG_DOUBLE>( true, AC_KEYS::CoplanarGapHeightRatio,
            &m_CoplanarGapHeightRatio, m_CoplanarGapHeightRatio, 1.0, 40.0 ) );
