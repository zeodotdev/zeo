...
AGENT_FRAME::AGENT_FRAME( KIWAY* aKiway, wxWindow* aParent ) :
        ...
        // m_trackAgentBtn( nullptr ),       // DISABLED
        // m_isTrackingAgent( false ),       // DISABLED
        ...
        m_pendingOpenPcb( false )
{
    ...
    // Track Agent Button - DISABLED: Users view changes via Changes tab
    ...
    // m_trackAgentBtn->Bind( wxEVT_BUTTON, &AGENT_FRAME::OnTrackAgentClick, this );  // DISABLED
