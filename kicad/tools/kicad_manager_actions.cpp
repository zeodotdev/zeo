...
TOOL_ACTION KICAD_MANAGER_ACTIONS::showAiAssistant( TOOL_ACTION_ARGS()
                                                            .Name( "kicad.Control.showAiAssistant" )
                                                            .Scope( AS_GLOBAL )
                                                            .DefaultHotkey( MD_CTRL + 'S' )
                                                            .LegacyHotkeyName( "Show AI Assistant" )
                                                            .FriendlyName( _( "AI Assistant" ) )
                                                            .Tooltip( _( "Open AI Assistant (Cmd+S)" ) )
                                                            .Icon( BITMAPS::info )
