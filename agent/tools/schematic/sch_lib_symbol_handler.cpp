                                                    ...
                                                    const nlohmann::json& aInput ) const
{
    ...
    code << "import json, re, fnmatch, sys\n"
         ...
         << "    if include_pins:\n"
         << "        pins = []\n"
         << "        # Read pin data from SymbolInfo.pins (List[LibPinInfo], populated by search/get_symbol_info)\n"
         ...
         << "                }\n"
         << "                # LibPinInfo stores position_x/position_y in nanometers\n"
         ...
         << "        # Fallback: use pin_names if no structured pin data available\n"
